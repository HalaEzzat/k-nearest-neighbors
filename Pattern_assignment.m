%Trees%
X1 = Feature_Extraction('dataset/tree1.jpg');
X1 = [X1 1];
X2 = Feature_Extraction('dataset/tree2.jpg');
X2 = [X2 1];
X3 = Feature_Extraction('dataset/tree3.jpg');
X3 = [X3 1];
X4 = Feature_Extraction('dataset/tree4.jpg');
X4 = [X4 1];
X5 = Feature_Extraction('dataset/tree5.jpg');
X5 = [X5 1];
